        ...
        <div >
            <div className="row pt-4 pb-4 alert-info" style={{margin: 0}}>
                <div className="col pl-4">
                    <ImageInput src={"http://localhost:8080/Employees/profile_picture/"+params.employee_id} />
                </div>
            ...
            <div className="row" style={{margin: 0}}>
                        ...
                        return (
                            <div key={index} className="col-sm-12 col-lg-6">
                                <AddressCard
                                    data={address}
                                    displayType={"show"}
                                    editable={params.employee_id == loggedUser.employee_id}
                ...
                {params.employee_id == loggedUser.employee_id ? (
